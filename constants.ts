import { HardDrive, Cloud, FileText, Image as ImageIcon, Video, Music, Archive, type LucideProps, Home, Star, Files } from 'lucide-react';
...
export const SIDEBAR_ITEMS = {
  architect: [
    ...
    { id: 'all-files', icon: Files, label: 'All Files' },
